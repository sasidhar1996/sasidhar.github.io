...
<!--    <div id="container">
      <header> PHOTO GALARY </header>
    <div>
    <ul>
    <li><img src="img/img.jpg" alt=" galary" width="35%"</li>
    <li><img src="img/imgg.jpg" alt=" galary" width="35%"</li>
    <li><img src="img/imggg.jpg" alt=" galary" width="35%"</li>
    <li><img src="img/imgggg.jpg" alt=" galary" width="35%"</li>
